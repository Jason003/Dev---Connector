...
// @desc get all of user's profile
// @access Public
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const newExperience = {};
      if (school) newExperience.school = school;
      if (degree) newExperience.degree = degree;
      if (fieldofstudy) newExperience.fieldofstudy = fieldofstudy;
      if (from) newExperience.from = from;
      if (to) newExperience.to = to;
      if (current) newExperience.current = current;
      if (description) newExperience.description = description;

      profile.education[updateIndex] = newExperience;
